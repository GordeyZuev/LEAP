    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-card/90 backdrop-blur-sm border-b border-border">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <AgeRatingBadge label="Возрастное ограничение: 12+" />
        </div>
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link
            href="/login"
            className="pressable px-3 py-1.5 text-xs sm:px-4 sm:py-2 sm:text-sm font-medium border border-border text-secondary-foreground rounded-xl hover:bg-muted"
          >
            Войти
          </Link>
          <Link
            href="/register"
            className="pressable px-3 py-1.5 text-xs sm:px-4 sm:py-2 sm:text-sm font-medium bg-primary text-white rounded-xl hover:bg-primary-hover"
          >
