  ...
  return (
    <section className="py-16 px-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl font-bold text-gray-900 text-center mb-2">Как это работает</h2>
        <p className="text-sm text-gray-500 text-center mb-10">От записи до публикации – несколько минут</p>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step) => (
            <div key={step.n} className="relative">
              <div className="text-4xl font-black text-[#224C87]/15 mb-3 leading-none">{step.n}</div>
