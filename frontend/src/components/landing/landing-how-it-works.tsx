...
const steps = [
  ...
  },
  {
    ...
    description: "YouTube, Яндекс.Диск или ссылка LEAP – одной кнопкой или по расписанию, с описанием и тегами.",
  },
  {
    n: "04",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, index) => (
            <div
              key={step.n}
              className={`relative ${inView ? "animate-card-in" : "opacity-0"}`}
