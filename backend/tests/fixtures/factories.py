...
def create_mock_recording(
    ...
    **kwargs,
    ...
    recording.final_duration = kwargs.get("final_duration")
    ...
    recording.share_enabled = kwargs.get("share_enabled", bool(kwargs.get("share_token")))
    recording.allow_video_download = kwargs.get("allow_video_download", True)
    recording.allow_files_download = kwargs.get("allow_files_download", True)
