...
async def sync_job_to_beat(session: AsyncSession, job: AutomationJobModel) -> None:
    ...
    try:
        ...
        # last_run_at: set to epoch on INSERT and on UPDATE when NULL.
        # NULL causes the first fire to be silently skipped by the scheduler.
        upsert_task = text("""
            ...
            SET crontab_id = EXCLUDED.crontab_id,
                ...
                last_run_at = COALESCE(celery_periodic_task.last_run_at, '1970-01-01'),
                date_changed = NOW()
        """)
