...
GET    /api/v1/share/p/{token}[?view=full|catalog]  # full: item posters presigned; catalog: no poster presign (poster_url null)
...
GET    /api/v1/share/p/{token}/items/{itemId}/media?type=processed|original[&download=true]
